import {SET_USER_ID, SET_USER_FOLLOWED_COMMUNITIES, SET_USER_TOKEN, SET_USER_PUSH_TOKEN, SET_USER_COMMUNITIES, SET_USER_FIRST_NAME, SET_USER_LAST_NAME, SET_USER_IMAGE, SET_USER_LATITUDE, SET_USER_LONGITUDE,SET_USER_STATUS, SET_USER_PASSWORD, SET_USER_NEARBY_VETERINARIES, SET_USER_NEARBY_PET_SHOPS, SET_USER_UNFOLLOWED_COMMUNITIES, ADD_FOLLOWED_COMMUNITY, REMOVE_UNFOLLOWED_COMMUNITY, USER_NOTIFICATIONS, ADD_USER_COMMUNITY} from '../constants'
...
export const setUserPushToken = userPushToken => dispatch => {
    dispatch({
        type: SET_USER_PUSH_TOKEN,
        payload: userPushToken 
    }) 
}
...
export const addUserCommunityId = nc_item => dispatch => {
    dispatch({
