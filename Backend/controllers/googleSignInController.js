...
exports.getUserInfo = function(req, res) {
    ...
    User.findOne({email: req.body.email}, {_id: 1, first_name:1, last_name:1, email:1, status:1, online:1, token:1, account_type:1, image:1, latitude:1, longitude:1, communities:1, password: 1, push_token: 1}).then((user)=>{
